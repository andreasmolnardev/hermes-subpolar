...
Contributors who run `hermes --tui --dev` from many worktrees should keep the
TUI workspace dependencies installed from the repository root.
:::

### External prebuild

Distributions that ship a prebuilt bundle can point Hermes at it:
